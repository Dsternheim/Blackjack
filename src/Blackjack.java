...
public class Blackjack {
	...
	public static void main(String[] args) {
		...
		System.out.println("Welcome to Blackjack. "
				+ "This game will be played with you versus the AI who is the dealer");
...
//		TODO delete upon finishing code
//		for(int i=0; i<deck.length; i++){
//			for(int j=1; j<(deck.length-i); j++){
//				if(deck[j-1].getRank() > deck[j].getRank()){
//					DeckOfCards temp = deck[j-1];
//					deck[j-1] = deck[j];
//					deck[j] = temp;
//				}
//			}
...
//		for(int i=0; i<deck.length; i++){
//			System.out.println("Suit: "+deck[i].getSuit()+",Rank: "+deck[i].getRank());
//		}
	...
	/*
	 * Performs the user turn, continues until user exceeds total value of 21 or hits the stand command
	 * */
	public static void performUserTurn(){
		...
		if(card1 > 10){
			...
			//TODO fix the ACE scoring to pick between 1 or 11 for both card 1 and card 2
			card1=10;
		...
		try{
			...
			while(currentUserScore <= 21){
				...
				//TODO Optional adding Splitting
				...
				System.out.println("You just drew " +rankToString(temp.getRank())+" of "+suitToString(temp.getSuit()));
	 ...
	 * @param suit
	 * 	the int value of the suit of the card
	 * @return
	 ...
	 * @param rank
	 * 	the int value of the rank of the card
	 * @return
	 * 	the card rank as a String
	 * */
	...
	/*
	 * Prints the curretn cards in the user's hand
	 * */
	 ...
	 * @return
	 * 	true if the user enters 'y', false if the user enters 'n'
	 * */
